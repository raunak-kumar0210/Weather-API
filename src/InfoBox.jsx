...
export default function InfoBox({ info }) {
  const MODERATE_URL =
    "https://plus.unsplash.com/premium_photo-1661934660615-4918f28476f9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y2xpbWF0ZXxlbnwwfHwwfHx8MA%3D%3D";
  const COLD_URL =
  ...
  const HOT_URL =
    "https://images.unsplash.com/photo-1415381266596-3975189f3277?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTB8fHN1bnxlbnwwfHwwfHx8MA%3D%3D";
  const RAIN_URL =
    "https://plus.unsplash.com/premium_photo-1700131051396-307a36e3ef85?q=80&w=1269&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
  ...
  useEffect(() => {
    ...
    return () => {
      // Cleanup: Reset body styles on unmount
        ...
        <Card sx={{ maxWidth: 345, backgroundColor: 'rgba(255, 255, 255, 0.8)' }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary' }} component={'span'}>
              ...
              <p>Max Temp = {info.tempMax}&deg;C</p>
              <p>
                The weather can be described as <b>{info.weather}</b> and feels like {info.feelsLike}
                &deg;C
              </p>
            </Typography>
          </CardContent>
